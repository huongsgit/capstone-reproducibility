...
I used a 2-way between-subjects ANOVA to seef if party affliliation and sex predict posttest optimism scores independently or in an interaction.
...
I will also run a regression using sex instead of party, so that I can find intercepts and create the plot as instructed below.
